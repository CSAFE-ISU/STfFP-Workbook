...
2. The $p$-values that result from hypothesis tests depend heavily on the sample size. If you have the same _______ and standard deviation, but ___________ the sample size, the result will me more significant, due to the sample size alone. \vspace{.1in}
